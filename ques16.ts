...
console.log(`Sorry ${guest1}, you are not invited to dinner\n`);
let guest2 = guests.pop();
console.log(`Sorry ${guest2}, you are not invited to dinner\n`);
let guest3 = guests.pop();
console.log(`Sorry ${guest3}, you are not invited to dinner\n`);
let guest4 = guests.pop();
console.log(`Sorry ${guest4}, you are not invited to dinner\n`);
